...
def parse_args(default=False):
    ...
    parser.add_argument('--dataset', help='Dataset',
                        choices=['STL-10', 'cub-birds', 'stanford-cars', 'cifar100-versus-other-eval', 'cifar10-versus-other-eval', 'ISIC2018', 'ArtBench', 'high-variational-brain-tumor', 'svhn-10-corruption', 'mvtec-high-var-corruption', 'cifar100-corruption', 'cifar100-versus-10', 'cifar10-versus-100', 'WBC', 'dtd', 'cifar10-corruption', 'mnist-corruption', 'ucsd', 'mvtec-high-var','head-ct', 'fashion-mnist', 'mnist', 'cifar10', 'cifar100', 'imagenet', 'svhn-10', 'MVTecAD', 'dior'],
