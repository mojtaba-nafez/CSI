...
def parse_args(default=False):
    ...
    parser.add_argument('--model', help='Model',
                        choices=['resnet18-corruption', 'SEResNet18', 'pretrain-resnet152-corruption', 'pretrain-resnet152', 'vit_fitymi', 'vit', 'resnet18', 'resnet18_imagenet', 'pretrain-resnet18'], default="resnet18", type=str)
