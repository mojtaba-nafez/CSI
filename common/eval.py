...
if P.dataset=='mvtec-high-var-corruption' or P.dataset=='mvtec-high-var' or P.dataset=="MVTecAD" or P.dataset=="WBC" or P.dataset=='cifar10-versus-100' or P.dataset=='cifar100-versus-10' or P.dataset=='cifar10-versus-100-supervised' or P.dataset=='cifar100-versus-10-supervised' or P.dataset=='cifar10-versus-other-eval' or P.dataset=='cifar100-versus-other-eval':
...
if P.dataset=='cifar10-versus-other-eval' or P.dataset=='cifar100-versus-other-eval' or P.dataset=='WBC' or P.dataset=='mvtec-high-var-corruption' or P.dataset=="MVTecAD" or P.dataset=="mvtec-high-var" or P.dataset=='cifar10-versus-100' or P.dataset=='cifar100-versus-10' or P.dataset=='cifar10-versus-100-supervised':
    P.ood_dataset = [1]
