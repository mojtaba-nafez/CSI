...
model = ModifiedResNet(layers=model_layers, output_dim=model_output_dim, heads=model_heads, input_resolution=model_input_resolution, width=model_width)
model(torch.rand(4, 3, model_input_resolution, model_input_resolution)).shape