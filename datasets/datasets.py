...
def get_exposure_dataloader(P, batch_size = 64, image_size=(224, 224, 3),
    ...
    if P.dataset == "MVTecAD":
        ...
        elif P.dataset=='dtd' or P.dataset=='FGVC':
            train_transform_cutpasted = transforms.Compose([
                transforms.Resize((image_size[0], image_size[1])),
        ...
        if P.dataset=='WBC' or P.dataset=='FGVC':  
        ...
        if P.dataset=='FGVC' or P.dataset=='head-ct' or P.dataset=='mvtec-high-var' or P.dataset=='ucsd' or P.dataset=='WBC' or P.dataset=='cifar100-versus-10' or P.dataset=='cifar10-versus-100':
